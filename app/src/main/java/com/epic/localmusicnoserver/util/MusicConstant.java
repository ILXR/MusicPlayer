...
public class MusicConstant {
    ...
    public static final String LABEL_MYLOVE = "我的最爱";
    ...
    //fragment_title
    public static final String FRAGMENT_MYLOVE     = "我的最爱";
    ...
    //更新播放列表模式
    public static final String UPDATE_PLAY_MODE     = "com.epic.localmusic.UPDATE_PLAY_MODE";
